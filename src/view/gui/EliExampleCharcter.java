...
//		paintEvent.gc.setBackground(new Color(null,0,0,0));
		...
		try {
			...
			//character = new BufferedInputStream(new FileInputStream("lib/hackchar.png"));
			Image im = new Image(null, character);
			paintEvent.gc.drawImage(im, 0, 0, im.getImageData().width, im.getImageData().height, x, y, characterWidth, characterHeight);
